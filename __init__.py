...
bl_info = {
    "name": "Scalable Vector Graphics (SVG) 1.2 format",
    "author": "JM Soler, Sergey Sharybin,Amry Ramadhan Prasetya",
    "blender": (2, 80, 0),
...
def menu_func_import(self, context):
    self.layout.operator(ImportSVG.bl_idname,
        text="Import SVG with correct name")
